                            ...
                            if (day != "name" && day != "_id" && day != "database") {
                                for (let j = 0; j < x2[day].length; j++) {
                                    if (x2[day][j][0] != "" && x2[day][j][1] != "" && x2[day][j][2] != "") {
                                        ...
                                        await collection2.findOneAndUpdate({ name: "records", [`${day}.${j}`]: data.orgvalue }, { $set: { [`${day}.${j}.$`]: data.modvalue } }, { returnDocument: 'after' })
                        ...
                        if (day != "name" && day != "_id" && day != "database") {
                            ...
                            for (let j = 0; j < x2[day].length; j++) {
                                ...
                                if (x2[day][j][0] != "" && x2[day][j][1] != "" && x2[day][j][2] != "") {
                                    ...
                                    await collection3.findOneAndUpdate({ name: "records", [`${day}.${j}`]: data.orgvalue }, { $set: { [`${day}.${j}.$`]: data.modvalue } }, { returnDocument: 'after' })
